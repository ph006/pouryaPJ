...
CONTACT_FILE_PATH = r"D:\Github\pouryaPJ\sas\contactlist04\file\contact.txt"
...
def _validation(contact: dict):
    ...
    Student_ID = contact.get("Student  ID").strip()
    National_ID = contact.get("National ID").strip()
    Age = contact.get("Age").strip()
