...
def _validation(contact: dict):
    ...
    name = contact.get("First name").strip()
    family = contact.get("Last name").strip()
    phone = contact.get("Phone number").strip()
...
def create_contact(contact: dict) -> dict:
    ...
    for cnt in result["RETURN_DATA"]:
        if cnt["Phone number"] == contact["Phone number"]:
            function_result["SUCCESS"] = False
            function_result["ERROR_MESSAGE"]["Phone number"] = f"{contact['Phone number']} exist"
...
def remove_contact(phone: str) -> dict:
    ...
    function_result["SUCCESS_MESSAGE"]["success"] = "weeeeeee :D"
    return function_result
    # endregion
...
def edit_contact(contact: dict) -> dict:
    ...
    for cnt in contact_list:
        ...
        function_result["SUCCESS"] = False
        function_result["ERROR_MESSAGE"]["Phone number"] = f"{contact['Phone number']} does not exist"
